...
const HappinessDialog: React.FC<HappinessDialogProps> = ({
  ...
  const handleHappinessChange = (_event: Event, newValue: number | number[]) => {
  ...
  const getHappinessIcon = (value: number) => {
    switch(value) {
      case 1: return <SentimentVeryDissatisfiedIcon fontSize="large" sx={{ color: theme.palette.error.main }} />;
      case 2: return <SentimentDissatisfiedIcon fontSize="large" sx={{ color: theme.palette.warning.main }} />;
      case 3: return <SentimentNeutralIcon fontSize="large" sx={{ color: theme.palette.info.main }} />;
      case 4: return <SentimentSatisfiedIcon fontSize="large" sx={{ color: theme.palette.success.light }} />;
      case 5: return <SentimentSatisfiedAltIcon fontSize="large" sx={{ color: theme.palette.success.main }} />;
      default: return <SentimentNeutralIcon fontSize="large" />;
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        <Typography component="div" variant="h6">How do you feel after completing this task?</Typography>
        <IconButton 
          edge="end" 
          color="inherit" 
          onClick={onClose} 
