'use client';
import { Box, Typography, useTheme, Grid, Paper, alpha, LinearProgress } from '@mui/material';
  ...
  return (
    <Box sx={{ 
        ...
        <LinearProgress
          ...
          sx={{
            ...
            '& .MuiLinearProgress-bar': {
              background: `linear-gradient(90deg, ${getColorValue()} 0%, ${theme.palette.primary.light} 100%)`,
              borderRadius: 4,
            },
          }}
        />
      ...
      >
        ...
        <Box>
          <Typography variant="subtitle2" color={getColorValue()} fontWeight="medium">
            {status.level}
          </Typography>
