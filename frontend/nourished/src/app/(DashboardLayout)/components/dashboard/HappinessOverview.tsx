...
const getHappinessIcon = (value: number) => {
  switch (Math.round(value)) {
    ...
    case 2:
      return <SentimentDissatisfiedIcon fontSize="small" color="warning" />;
    case 3:
      return <SentimentNeutralIcon fontSize="small" color="info" />;
    case 4:
      return <SentimentSatisfiedIcon fontSize="small" color="success" />;
    case 5:
...
const calculateAverageHappiness = (
  data: HappinessOverviewProps["happinessData"]
) => {
...
const HappinessOverview: React.FC<HappinessOverviewProps> = ({
  happinessData,
  isLoading,
  error,
}) => {
  ...
  const averageHappiness = happinessData
    ? calculateAverageHappiness(happinessData)
    : 0;
      ...
      <DashboardCard title="Your Happiness">
        <Box sx={{ p: 3, textAlign: "center" }}>
          <Typography color="textSecondary">
            No happiness data available yet. Complete tasks and rate your
            happiness to see insights here.
          </Typography>
        </Box>
      </DashboardCard>
    );
    ...
    >
      <CardContent>
            ...
            <Box sx={{ textAlign: "center", p: 1 }}>
              ...
              <Box sx={{ mt: 3 }}>
                ...
                <SimpleBar
                  ...
                  maxValue={Math.max(...ratingCounts, 1)}
        ...
        <Typography variant="body2" color="textSecondary" align="center">
          Your happiness ratings help us understand the impact of tasks on your
          well-being.
        </Typography>
      </CardContent>
    </DashboardCard>
